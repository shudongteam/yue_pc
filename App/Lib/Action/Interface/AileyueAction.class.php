<?php
class AileyueAction extends Action {
    ...
    public function index($cp) {
        ...
        $this->display('Interface@Aileyue');
    }
    ...
    public function  test(){
      // header('Content-type: text/html;charset=utf-8');
       ...
       public function  booklistapi(){
        header("Content-type: text/html; charset=utf-8");
         $booklists = file_get_contents("http://www.leread.com/ilereader/push/book/list?userName=yueming&sign=83a4795290a40c6f2b94690157d799a2");
      ...
      public function  getbookinfo($partnerbookid){
        header("Content-type: text/html; charset=utf-8");
        $bookinfo = file_get_contents("http://www.leread.com/ilereader/push/book/detail?userName=yueming&sign=83a4795290a40c6f2b94690157d799a2&bookId=".$partnerbookid);
      ...
      private  function  getchapters($partnerbookid){
        header("Content-type: text/html; charset=utf-8");
        $chapters = file_get_contents("http://www.leread.com/ilereader/push/book/chapters?userName=yueming&sign=83a4795290a40c6f2b94690157d799a2&bookId=".$partnerbookid);
       ...
       private  function  getcontent($partner_bookid,$partner_chapterid){
            header("Content-type: text/html; charset=utf-8");
            $content = file_get_contents("http://www.leread.com/ilereader/push/book/content?userName=yueming&sign=83a4795290a40c6f2b94690157d799a2&bookId=".$partner_bookid."&sequence=".$partner_chapterid);
