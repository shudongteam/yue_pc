...
/*
-- ----------------------------
-- hezuo_n_auth_rule，规则表，
-- id:主键，name：规则唯一标识, title：规则中文名称 status 状态：为1正常，为0禁用，condition：规则表达式，为空表示存在就验证，不为空表示按照条件验证
-- ----------------------------
 DROP TABLE IF EXISTS `hezuo_n_auth_rule`;
CREATE TABLE `hezuo_n_auth_rule` (  
...
-- ----------------------------
-- hezuo_n_auth_group 用户组表， 
-- id：主键， title:用户组中文名称， rules：用户组拥有的规则id， 多个规则","隔开，status 状态：为1正常，为0禁用
-- ----------------------------
 DROP TABLE IF EXISTS `hezuo_n_auth_group`;
CREATE TABLE `hezuo_n_auth_group` ( 
    `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT, 
...
-- ----------------------------
-- hezuo_n_auth_group_access 用户组明细表
-- uid:用户id，group_id：用户组id
-- ----------------------------
DROP TABLE IF EXISTS `hezuo_n_auth_group_access`;
CREATE TABLE `hezuo_n_auth_group_access` (  
...
class Auth{
    ...
    protected $_config = array(
        ...
        'AUTH_GROUP' => 'hezuo_n_auth_group', //用户组数据表名
        'AUTH_GROUP_ACCESS' => 'hezuo_n_auth_group_access', //用户组明细表
        'AUTH_RULE' => 'hezuo_n_auth_rule', //权限规则表
        'AUTH_USER' => 'hezuo_n_amdin'//用户信息表
    );
